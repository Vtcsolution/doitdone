        ...
        <div className="mt-12 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto px-4">
            ...
            <div className="p-6 bg-white rounded-lg shadow-md dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
             ...
             <Button
  variant="brand"
  className="w-full rounded-full text-sm sm:text-base whitespace-normal break-words px-3 py-2 text-center leading-tight"
  onClick={handleLoveCompatibilityUnlock}
  disabled={isSubmitting}
>
  Ontgrendel liefdescompatibiliteit (10 credits)
</Button>
