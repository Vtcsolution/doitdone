...
export default function ChatDetail({ chat, onBack, onSendMessage }) {
  ...
  const debouncedStopPaidSession = debounce(async () => {
    ...
    try {
      ...
      setTimerActive(true);
      setTimerDuration(activePaidSession?.paidTimer || 0);
      setActivePaidSession({ psychicId: chat._id, paidTimer: activePaidSession?.paidTimer || 0 });
